...
def transform_bronze_to_silver(transactions: list, merchants: list) -> list:
    ...
    Args:
        transactions: List of bronze transaction dictionaries.
        merchants: List of merchant dictionaries.

    Returns:
        List of silver transaction dictionaries.
    """
...
def load_silver(con: duckdb.DuckDBPyConnection, silver_rows: list) -> None:
    ...
    Args:
        con: The database connection.
        silver_rows: List of silver transaction dictionaries.
    """
...
def compute_merchant_performance(silver_rows: list) -> list:
    ...
    Returns:
        List of merchant performance dictionaries.
    """
    from collections import defaultdict
...
def load_gold(con: duckdb.DuckDBPyConnection, merchant_perf: list, daily_summary: list) -> None:
    ...
    Args:
        con: The database connection.
        merchant_perf: List of merchant performance dictionaries.
        daily_summary: List of daily summary dictionaries.
    """
